        ...
        content = Column(
            controls=[
                ...
                Stack(
                    controls= [
                        tasks,
                        FloatingActionButton(bottom=3,right=20,
    ...
    page_1 = Container(
        ...
        content=Column(
            controls=[
                Row(alignment='end',
                    controls=[
                        Container(border_radius=25, padding=padding.only(top=13,left=3),
                        height=50,
                        width=50,
                ...
                Container(height=20),
                circle,
                Text('Olivia \n Michel',size=32,weight='bold'),
                Container(height=20), 
                Row(controls=[
                    Icon(icons.FAVORITE_BORDER_SHARP,color = PINK),
                    Text('Templates',size = 15, weight = FontWeight.W_300,
                    color='white',font_family='poppins')
                ]),
                Container(height=5),
                 Row(controls=[
                    Icon(icons.CARD_TRAVEL,color = PINK),
                    Text('Categories',size = 15, weight = FontWeight.W_300,
                    color='white',font_family='poppins')
                ]),
                Container(height=5),
                 Row(controls=[
                    Icon(icons.CALCULATE_OUTLINED,color = PINK),
                    Text('Templates',size = 15, weight = FontWeight.W_300,
                    color='white',font_family='poppins')
                ]),
                Image(src=f"/images/1.png",width=300,height=200),
...
app(target = main,view= WEB_BROWSER,assets_dir='asset')
